...
public class AlerteMessage {
	...
	private  String error = "Une erreur s'est produite. Veuillez ferme l'application et la réouvrir.";
     ...
     */
    public AlerteMessage(String pseudoExpediteur, String option, int type){
