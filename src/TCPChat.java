	...
	public void run() {
		...
		try {
			while (!this.sock.isClosed()) {
				 /*On rÈcupËre le n∞ port donnÈ dans user ?
...
try {
    ...
    System.out.println("Erreur cr√©ation du server1");
}
try {
    ...
    System.out.println("Erreur cr√©ation des inS1 et outS1");
}
...
try {
    ...
    System.out.println("Erreur cr√©ation du socket client user1");
}
try {
    ...
    System.out.println("Erreur cr√©ation des inC et outC");
}
//Communication
...
//fermeture des diff√©rents sockets
try {
sock.close();
}
}*/ 